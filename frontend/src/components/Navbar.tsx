...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, navigate, token, setToken, setCartItems } = useShopContext();
    ...
    return (
        <div className="flex items-center justify-between py-5 font-medium h-max">
