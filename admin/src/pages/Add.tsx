...
const Add = ({ token }: string) => {
    ...
    const [image1, setImage1] = useState<Blob | null>('')
    const [image2, setImage2] = useState<Blob | null>(null)
    const [image3, setImage3] = useState<Blob | null>(null)
    const [image4, setImage4] = useState<Blob | null>(null)
        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
                ...
                <div>
                    ...
                    <input onChange={(e) => setPrice(Number(e.target.value))} value={price} className="w-full px-3 py-2 sm:w-[120px]" type="number" placeholder="25" />
                </div>
            </div>
